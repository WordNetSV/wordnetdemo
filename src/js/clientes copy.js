...
firebase.initializeApp({
 ...
 db.collection("client2p").onSnapshot((querySnapshot) => {
    tabla.innerHTML = '';
...
function eliminar(id){
    db.collection("client2p").doc(id).delete().then(function() {
...
//cambiar 6
  document.getElementById('nombre').value = nombre;
    ...
    boton.onclick = function () {
        var washingtonRef = db.collection("client2p").doc(id);
  ...
  db.collection("client2p").where("state", "==", "CA")
